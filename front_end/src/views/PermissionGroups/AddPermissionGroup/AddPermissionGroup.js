...
class AddPermissionGroup extends Component {
  ...
  componentDidMount() {
   ...
   saveGroup(event) {
    ...
    const formData = new FormData();
      ...
      fetch(config.serverUrl+'/saveGroupPermissions', {
        method: 'POST',
        body: formData 
      }).then(function(response)   {
                    ...
                    moduleNames[module].map(function(name, i) {
                      return (
                            <FormGroup check className="checkbox">
                              <Input className="form-check-input" type="checkbox" id={i} name={name} value="option1" onChange={(e) => self.handleChange(e,module,name)}/>
              ...
              <Row>
                ...
                <Col xs="12" md="4">
                  <div className="form-actions">
                    <Button color="primary" onClick={this.saveGroup}>Save Group</Button>
                  </div>
                </Col>
              </Row>  
              </CardBody>
