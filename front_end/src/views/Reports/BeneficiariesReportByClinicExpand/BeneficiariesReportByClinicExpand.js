...
class BeneficiariesReportByClinicExpand extends Component {
      ...
      <React.Fragment>
        ...
        <Col md="10">
          ...
          <FormGroup check inline>
            ...
            <h2>Beneficiaries Management Report By Clinic Expand</h2>
          </FormGroup>
          <FormGroup check inline>
...
export default BeneficiariesReportByClinicExpand;
