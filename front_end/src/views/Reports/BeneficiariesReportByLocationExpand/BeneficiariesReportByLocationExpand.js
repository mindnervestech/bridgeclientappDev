...
class BeneficiariesReportByLocationExpand extends Component {
    ...
    componentDidMount() {
        ...
        self.getBeneficiariesClinicRowData();
 
    }

  getBeneficiariesClinicRowData()
  {
      ...
      <React.Fragment>
        ...
        <Col md="10">
          ...
          <FormGroup check inline>
            ...
            <h2>Beneficiaries Management Report By Location Expand</h2>
          </FormGroup>
          <FormGroup check inline>
...
export default BeneficiariesReportByLocationExpand;
