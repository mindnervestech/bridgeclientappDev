...
class BeneficiariesReportByDoctorExpand extends Component {
    ...
    componentDidMount() {
        ...
        self.getBeneficiariesDoctorRowData();
 
    }

    getBeneficiariesDoctorRowData()
  {
      ...
      <React.Fragment>
        ...
        <Col md="10">
          ...
          <FormGroup check inline>
            ...
            <h2>Beneficiaries Management Report By Doctor Expand</h2>
          </FormGroup>
          <FormGroup check inline>
...
export default BeneficiariesReportByDoctorExpand;
