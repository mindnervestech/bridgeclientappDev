...
class AdmissionReportExpand extends Component {
  ...
  componentDidMount() {
    ...
    self.getAdmissionReportsRowData();
 
  }
  getAdmissionReportsRowData(rowInfo) {
    self.setState({
        admissionsReportExpandPatientName   : localStorage.getItem('admissionsReportExpandPatientName'),
        admissionsReportExpandSubscriberId  : localStorage.getItem('admissionsReportExpandSubscriberId'),
        admissionsReportExpandPcpName : localStorage.getItem('admissionsReportExpandPcpName'),
        admissionsReportExpandEligibleMonth : localStorage.getItem('admissionsReportExpandEligibleMonth'),
    });
...
export default AdmissionReportExpand;
